...
def seed_historical_events(db: Session, epochs):
    ...
    events = [
        ...
        HistoricalEvent(
            ...
            description="Енисей стал колыбелью жизни в Сибири еще в глубокой древности. Около 20 тысяч лет назад на его высоком берегу, у Афонтовой горы, обосновались первые охотники на мамонтов. Река обеспечивала их водой и служила ориентиром в бескрайних землях. Сегодня это место — важнейший археологический памятник мирового значения. Именно здесь начиналась летопись человеческого присутствия на берегах великой артерии.",
        ...
        HistoricalEvent(
            ...
            description="На отвесных скалах правого берега притока Енисея застыла «каменная книга» древних художников. На протяжении тысячелетий люди высекали здесь образы лосей, лодок и мифических существ. Эти рисунки отражают духовный мир народов, чья жизнь была неразрывно связана с речными циклами. Река была для них священным путем, соединяющим миры живых и предков. Петроглифы и сегодня безмолвно охраняют покой енисейских вод.",
        ...
        HistoricalEvent(
            ...
            description="Средневековая история Енисея неразрывно связана с формированием самобытных культур коренных народов. Хакасы и кеты осваивали плодородные долины и богатые рыбой притоки, создавая уникальный быт в суровых условиях. Традиционные юрты и чумы стали символом гармонии человека с сибирской природой. Река служила главным транспортным путем и источником жизни для целых цивилизаций. Их наследие до сих пор живет в традициях и легендах приенисейского края.",
        ...
        HistoricalEvent(
            ...
            description="Енисейск стал первым русским городом на великой реке и «отцом» всех восточносибирских поселений. Основанный отрядом казаков под руководством Петра Албычева, острог быстро превратился в главный торговый и административный центр края. Город удачно расположился в месте, где речные пути расходились во все стороны света, открывая дорогу к Байкалу и океану. Енисейск стал базой для сбора ясака и отправной точкой для легендарных экспедиций первопроходцев. На десятилетия он закрепил за собой статус золотых ворот Сибири. Сегодня его уникальная архитектура хранит дух той дерзкой эпохи освоения речных просторов.",
        ...
        HistoricalEvent(
            ...
            description="Хотя главные открытия Дежнева связаны с Беринговым проливом, его путь неразрывно переплетен с енисейской логистикой того времени. Выйдя из Тобольска и пройдя через Енисейск, казаки использовали великую реку как надежную магистраль для продвижения на восток. На легких кочах исследователи преодолевали суровые пороги, стремясь к неизведанным «краям земли». Дежнев доказал, что из северных рек можно выйти в открытый океан, обогнув крайнюю оконечность материка. Этот поход стер белые пятна с карты мира и подтвердил статус Енисея как важнейшего звена в глобальных географических открытиях. Мужество этих людей навсегда вписано в историю освоения Арктики.",
        ...
        HistoricalEvent(
            ...
            description="Красный Яр был заложен воеводой Андреем Дубенским как южный форпост для защиты енисейских земель. Место для крепости выбрали на высоком левом берегу, в месте впадения Качи в Енисей, где скалы отливали характерным рыжим цветом. Острог должен был сдерживать набеги кочевников и обеспечивать безопасность речного пути. Жизнь первых поселенцев была тяжелой и опасной, превращая каждый день в борьбу за выживание. Со временем военная крепость переросла свои стены, став фундаментом для будущего мегаполиса. Сегодня на месте высадки казаков стоит Покровская гора, с которой открывается вид на могучее течение реки.",
        ...
        HistoricalEvent(
            ...
            description="В 1830-х годах Енисей охватила настоящая «золотая лихорадка», превратив регион в центр мировой добычи драгоценного металла. Тысячи старателей устремились в глухую тайгу, основывая прииски по берегам северных рек. Енисей стал главной дорогой для доставки провианта, оборудования и сотен рабочих на дальние прииски. Золото принесло в край огромные капиталы, на которые строились школы, театры и каменные особняки в городах. Этот период навсегда изменил социальный облик Сибири, сделав её богатейшей провинцией империи. Могучая река буквально наполнилась блеском золотого песка и гулом старательских работ.",
        ...
        HistoricalEvent(
            ...
            description="1863 год ознаменовал начало новой технической эры — на Енисей спустили первый пароход «Енисей». Теперь мощное течение реки перестало быть преградой, и суда могли двигаться против потока с небывалой скоростью. Пароходы связали отдаленный север с южными округами, сделав перевозки регулярными и надежными. Речные пристани превратились в шумные вокзалы, где встречались люди разных сословий и национальностей. Гудок парохода стал символом прогресса, который пробудил дремавшую веками тайгу. Постепенно Енисейское пароходство стало крупнейшим предприятием, управляющим всей логистикой Восточной Сибири.",
        ...
        HistoricalEvent(
            ...
            description="В 1895 году Великий Сибирский путь достиг берегов Енисея, объединив водную и железную артерии. Ключевым событием стало строительство грандиозного моста, который называли «венцом инженерного искусства». Это сооружение, получившее золотую медаль на Парижской выставке, соединило берега великой реки стальными нитями. Теперь товары из Европы в Азию доставлялись в считанные недели, минуя долгие речные переправы. Мост через Енисей стал символом того, что железная дорога окончательно «покорила» сибирские просторы. Это событие превратило Красноярск в важнейший транспортный узел страны.",
        ...
        HistoricalEvent(
            ...
            description="Экспедиция Николая Урванцева обнаружила колоссальные запасы руд на Крайнем Севере. Енисей стал единственной транспортной нитью, связавшей будущий промышленный гигант с остальным миром. Через речной порт Дудинка начались поставки техники и вывоз ценных металлов. Это открытие превратило суровую тундру в крупнейший индустриальный район планеты. Без водного пути Енисея освоение этих богатств было бы физически невозможным.",
        ...
        HistoricalEvent(
            ...
            description="Енисей был перегорожен бетонным гигантом, ставшим на тот момент мощнейшим в мире. Плотина создала огромное водохранилище, изменив климат и режим навигации на сотни километров. Для пропуска судов был построен уникальный судоподъемник — единственный в России. ГЭС дала дешевую энергию для алюминиевой промышленности края, превратив Красноярск в мощный заводской центр. Река из простого пути превратилась в неисчерпаемый источник электричества.",
        ...
        HistoricalEvent(
            ...
            description="В Саянских горах выросла самая высокая и мощная плотина России, укротившая крутой нрав верховий Енисея. Арочно-гравитационная конструкция стала шедевром инженерной мысли, выдерживая колоссальный напор воды. ГЭС обеспечила энергией крупнейшие предприятия Сибири и Сибирскую энергосистему. Величественный вид плотины среди гор стал символом триумфа человека над природой. Река здесь работает с максимальной отдачей, питая экономику целой страны.",
        ...
        HistoricalEvent(
            ...
            description="На берегу Енисея в строжайшей секретности был вырублен в скалах уникальный подземный город для производства оружейного плутония. Речная вода использовалась для охлаждения атомных реакторов, скрытых глубоко под землей. Десятилетиями этого города не было на картах, а его жизнь была полностью подчинена ядерному щиту СССР. Железногорск стал примером высших достижений советской науки и технологий. Енисей здесь выступил не только как транспорт, но и как ключевой элемент атомного проекта.",
        ...
        HistoricalEvent(
            ...
            description="В конце XX века пришло осознание, что десятилетия бурного промышленного роста нанесли реке серьезный урон. Сбросы заводов, работа ГЭС и атомное производство изменили экосистему и температуру воды, которая перестала замерзать у крупных городов. Экологические проблемы стали громкой темой для обсуждения, объединив ученых и общественность в борьбе за спасение речных богатств. Началась работа над очистными сооружениями и строгим мониторингом состояния воды. Этот период научил людей ценить Енисей не только как ресурс, но и как хрупкий природный дар. Сегодня сохранение чистоты великой реки — приоритетная задача для всего региона.",
        ...
        HistoricalEvent(
            ...
            description="В новом тысячелетии Енисей открылся миру как уникальное туристическое направление. По реке пошли современные круизные лайнеры, позволяющие увидеть и сибирскую тайгу, и арктические широты за одну поездку. Путешественников манят не только красоты природы, но и история древних стоянок, острогов и грандиозных плотин. Развитие инфраструктуры сделало суровые берега доступными для комфортного отдыха и экспедиций. Туризм стал новым экологичным способом познания Сибири, принося региону мировую известность. Теперь Енисей — это путь для тех, кто ищет настоящие приключения и масштабные виды.",
        ...
        HistoricalEvent(
            ...
            description="Сегодня Енисей остается главной жизненной артерией России, объединяющей традиции прошлого и технологии будущего. Река продолжает питать крупнейшие ГЭС, обеспечивая энергией города-миллионники и современные цифровые центры. Новые набережные и экологические проекты возвращают реку жителям, превращая её берега в лучшие места для жизни. Масштабные инвестиции в очистку русла и сохранение популяции рыб (например, знаменитого осетра) показывают ответственный подход к природе. Енисей в XXI веке — это символ силы, чистоты и неисчерпаемого потенциала великой Сибири. Мы учимся жить в гармонии с этим могучим потоком, сохраняя его для будущих поколений.",
